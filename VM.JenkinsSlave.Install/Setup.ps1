...
if (!$auto) {
    . $scriptDir\Install.Java.Certificates.ps1 -javaHome "$($nodeProperties.javaHome)" -certificatesDir "$($nodeProperties.downloadFolder)\Certificates" -forceJavaCertsReplace:$forceJavaCertsReplace
}

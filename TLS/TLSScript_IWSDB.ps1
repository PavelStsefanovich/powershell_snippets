...
Write-Host 'Multi-Protocol Unified Hello has been disabled for -----------> DB.'
...
Write-Host 'PCT 1.0 has been disabled for -----------> DB.'
...
Write-Host 'SSL 2.0 has been disabled for -----------> DB.'
...
Write-Host 'SSL 3.0 has been disabled for -----------> DB.'
...
Write-Host 'TLS 1.0 Server has been enabled for -----------> DB.'
...
Write-Host 'TLS 1.1 Server has been enabled for -----------> DB.'
...
Write-Host 'TLS 1.2 Server has been enabled for -----------> DB.'
...
Write-Host 'TLS 1.0 Client has been disabled for -----------> DB.'
# Add and Enable TLS 1.1 for client SCHANNEL communications
New-Item 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client' -Force | Out-Null
New-ItemProperty -path 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client' -name 'Enabled' -value 0 -PropertyType 'DWord' -Force | Out-Null
New-ItemProperty -path 'HKLM:\SYSTEM\CurrentControlSet\Control\SecurityProviders\SCHANNEL\Protocols\TLS 1.1\Client' -name 'DisabledByDefault' -value '0xffffffff' -PropertyType 'DWord' -Force | Out-Null
Write-Host 'TLS 1.1 Client has been disabled for -----------> DB.'
...
Write-Host 'TLS 1.2 has been enabled for -----------> DB.'
